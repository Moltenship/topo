...
export const SettingsPage = ({
  ...
  return (
    <main className="grid min-h-screen grid-cols-[208px_minmax(0,1fr)] overflow-hidden bg-background text-foreground max-md:grid-cols-1 max-md:overflow-auto">
      <aside className="flex min-h-screen flex-col border-r bg-card/70 px-3 py-4 max-md:min-h-auto">
      ...
      <section className="min-h-screen overflow-y-auto px-6 py-8 max-md:min-h-auto max-sm:px-4">
